    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "end_time",
                    models.DateTimeField(blank=True, null=True, verbose_name="Дата и время последней отправки"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mailing",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mailapp.mailing", verbose_name="Рассылка"
                    ),
                ),
            ],
            options={
